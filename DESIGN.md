...
- **`Views/ContentView.swift`** — root view; wraps `RemoteControlView` and sets a minimum/ideal size (min ≈360 × 600, ideal ≈400 × 740). The touch surface expands to fill any extra height when the window grows.
